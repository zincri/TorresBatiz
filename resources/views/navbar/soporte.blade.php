         ...
         <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pull-left">
            <div class="row">
               ...
               <div class="col-md-6 service_blog margin_bottom_50">
                  <div class="full">
                     <div class="service_img"> <img class="img-responsive" src="images/torresimages/4ab-cloud-IT.jpg" alt="#"> </div>
                     <div class="service_cont">
               ...
               <div class="col-md-6 service_blog margin_bottom_50">
                  <div class="full">
                     <div class="service_img"> <img class="img-responsive" src="images/torresimages/4ab-sad-Production-Print-Support.jpg" alt="#"> </div>
                     <div class="service_cont">
