            ...
            <div class="full">
               <div class="title-holder">
                  <div class="title-holder-cell text-left">
                     <h1 class="page-title">Sillería</h1>
                     <ol class="breadcrumb">
                        <li><a href="index.html">Inicio</a></li>
                        <li class="active">Sillería</li>
                     </ol>
                  </div>
               </div>
            </div>
         ...
         <div class="col-md-12">
            <div class="row productosList">
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                  <a href="/productostodosdetalle">
                     <div class="product_list">
                        <div class="product_img"> <img class="img-responsive" src="images/layout_img/5.jpg" alt=""> </div>
                        <div class="product_detail_btm">
                           <div class="center">
                              <h4># 5</h4>
                           </div>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                  <a href="/productostodosdetalle">
                     <div class="product_list">
                        <div class="product_img"> <img class="img-responsive" src="images/layout_img/6.jpg" alt=""> </div>
                        <div class="product_detail_btm">
                           <div class="center">
                              <h4># 6</h4>
                           </div>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                  <a href="/productostodosdetalle">
                     <div class="product_list">
                        <div class="product_img"> <img class="img-responsive" src="images/layout_img/7.jpg" alt=""> </div>
                        <div class="product_detail_btm">
                           <div class="center">
                              <h4># 7</h4>
                           </div>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                  <a href="/productostodosdetalle">
                     <div class="product_list">
                        <div class="product_img"> <img class="img-responsive" src="images/layout_img/8.jpg" alt=""> </div>
                        <div class="product_detail_btm">
                           <div class="center">
                              <h4># 8</h4>
                           </div>
